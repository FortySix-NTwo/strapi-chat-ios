# This folders Code is taken from the 'SwiftKeychainWrapper' 

With a couple of changes due to deprecation reasons as shown below 

> Within the 'KeychainWrapper.swift' file:
...
open func object(forKey key: String, withAccessibility accessibility: KeychainItemAccessibility? = nil) -> NSCoding? {
    ...
    // .unarchiveObject(with: data) was deprecated in iOS 12
...
@discardableResult open func set(_ value: NSCoding, forKey key: String, withAccessibility accessibility: KeychainItemAccessibility? = nil) -> Bool {
    ...
    // .archivedData(withRootObject: value) was deprecated in iOS 12
